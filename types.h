...
enum PieceType {
  ...
  DRAGON, UNICORN, HAWK, ELEPHANT, FORTRESS,
  ...
  // Aliases for Betza notation compatibility
  CUSTOM_PIECES = CUSTOM_PIECE_1,
  CUSTOM_PIECES_END = CUSTOM_PIECE_16,
...
const std::string PieceToChar(  " PNBRQCLAMSDUHEF................K" + std::string(PIECE_TYPE_NB - KING - 1, ' ')
                              + " pnbrqclamsduhef................k" + std::string(PIECE_TYPE_NB - KING - 1, ' '));
...
// Helper function for Betza notation custom pieces
